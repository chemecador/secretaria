...
internal class FirestoreRestNotesListsRepository(
    ...
    private suspend fun visibleListDocuments(userId: String): List<FirestoreDocument> =
        firestore.runQuery(
            structuredQuery = collectionQuery(
                collectionId = NOTES_LIST,
                arrayContainsFilter(CONTRIBUTORS, firestoreString(userId)),
...
private fun FirestoreDocument.withInheritedContributorPatch(
    ownerId: String,
    friendUserId: String,
    added: Boolean,
): FirestoreDocumentPatch {
...
private fun FirestoreDocument.withClearedGroupPatch(
    ownerId: String,
): FirestoreDocumentPatch {
...
private fun FirestoreDocument.withInheritedContributorsPatch(
    ownerId: String,
...
private fun FirestoreDocument.relativeDocumentPath(): String =
