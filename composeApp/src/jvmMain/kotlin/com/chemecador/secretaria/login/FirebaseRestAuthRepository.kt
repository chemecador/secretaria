...
internal class FirebaseRestAuthRepository(
    ...
    override suspend fun restoreSession(): Result<Boolean> {
        ...
        val loaded = persisted.toFirebaseAuthSession()
...
private fun FirebaseAuthSession.toPersisted(): PersistedAuthSession =
...
private fun PersistedAuthSession.toFirebaseAuthSession(): FirebaseAuthSession =
    FirebaseAuthSession(
        userId = userId,
        email = email,
        idToken = idToken,
