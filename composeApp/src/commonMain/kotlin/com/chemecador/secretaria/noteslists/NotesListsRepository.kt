...
interface NotesListsRepository {
    ...
    suspend fun setListGroup(listId: String, groupId: String?): Result<Unit>
    suspend fun reorderGroupedLists(groupId: String, listIdsInOrder: List<String>): Result<Unit>
